<div class="servicios">
    <div class="row">
        <p class="titulo-seccion" id="servicios">-  Nuestros Servicios -</p>
        <div class="col-7">
            <h5 class="container-servicios-father">1. ¡Es todo lo que necesitas!</h5>
            <p class="container-servicios-son">Graphic Money es una plataforma tecnológica integral que incluye todos los módulos necesarios para atender las necesidades de sus colaboradores; desde el pago de nómina hasta su desarrollo profesional. ¡Es muy fácil e intuitiva! Lo mejor es que puedes hacerlo desde cualquier dispositivo y en todo lugar. Para nosotros, la opinión de nuestros clientes es esencial a la hora de ofrecer y desarrollar mejoras continuas en el software y así entregarles una herramienta que pueda ayudarlos a ahorrar tiempo en sus tareas administrativas e invertirlo en lo que más importa, sus colaboradores y la cultura organizacional.</p>
        </div>
        <div class="col">
            <div class="img-servicios">
                <img src="img/serv1.jpeg" alt="">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col">
            <div class="img-servicios">
                <img src="img/servicios3.avif" alt="">
            </div>
        </div>
    </div>
